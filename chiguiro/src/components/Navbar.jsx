  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div className={`${styles.links} ${isMobileMenuOpen ? styles.showMenu : ''}`}>
        ...
        <a href="https://forms.gle/9shq4czv8t65yyrp9" className={`${styles.link} ${styles.inscripcionLink}`} target="_blank" rel="noopener noreferrer" onClick={toggleMobileMenu}>Inscripción!!</a>
      </div>
    </nav>
  );
};
