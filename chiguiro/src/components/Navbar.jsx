  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div className={`${styles.links} ${isMobileMenuOpen ? styles.showMenu : ''}`}>
        ...
        <a href="https://forms.gle/DEBsoSuBQgxmFvUUA" className={`${styles.link} ${styles.inscripcionLink}`} target="_blank" rel="noopener noreferrer" onClick={toggleMobileMenu}>Pre-Inscripción!!</a>
      </div>
    </nav>
  );
};
